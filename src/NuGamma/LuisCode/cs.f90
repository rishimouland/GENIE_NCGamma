...
!****************************************************************************
       ...
       common/ss/  c_ga,c_ga5,g,c_gsigma,unm,unm0,xk,xkp,xp,xpp,xqf,xq,s_kqf,xq0,xpd,xpdc,xenergy,start,finish,&
                  beta_cos, &
                  xpf0,  Ddensity, w_sqf0, fca5p33,qfmin,      &                      ! 
                  ndiag,nnstep,nucleon,nff,nprecise,mdelta
...
!      endif
      ...
      print*,'Please select the nucleon: proton(1) or neutrion(-1)'       
      read(*,*),nucleon
...
!         ctcr=ctst1*sf
          ctcr=cdc*2*tw*sf
             ...
             write(8,*) xenergy,tq2,tw,real(ctcr),aimag(ctcr),nnstep
