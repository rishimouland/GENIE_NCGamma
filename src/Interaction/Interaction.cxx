...
//___________________________________________________________________________
Interaction * Interaction::RESNCGamma(int tgt, int nuc, int probe, double E)
{
  Interaction * interaction = 
    Interaction::Create(tgt,probe,kScRESNCGamma, kIntWeakNC);
...
//___________________________________________________________________________
Interaction * Interaction::RESNCGamma(
				      int tgt, int nuc, int probe, const TLorentzVector & p4probe)
{
  Interaction * interaction = 
    Interaction::Create(tgt,probe,kScRESNCGamma, kIntWeakNC);
