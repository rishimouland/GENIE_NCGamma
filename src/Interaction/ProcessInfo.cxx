...
/*
 ...
 @ Mar 09, 2016 - Pierre Lasorak
   Added IsRESSingleGamma
*/
//____________________________________________________________________________
...
//____________________________________________________________________________
bool ProcessInfo::IsRESNCGamma(void) const
{
  return (fScatteringType == kScRESNCGamma);
}
//____________________________________________________________________________
...
{
  return (fScatteringType == kScResonant || fScatteringType == kScRESNCGamma);
}
//____________________________________________________________________________
