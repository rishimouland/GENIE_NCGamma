...
public:
 ...
 ~Interaction();
  ...
  static Interaction * RESNCGamma(int tgt, int nuc, int probe, double E=0);
  static Interaction * RESNCGamma(int tgt, int nuc, int probe, const TLorentzVector & p4probe);
